...
public class DBHelper extends SQLiteOpenHelper{
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("create table if not exists call_history(id INTEGER PRIMARY KEY,number varchar, date varchar, time varchar, duration varchar, type varchar)");
	}
	...
	public boolean insertdata(String number, String date, String time,String duration, String type)
	{
		...
		sdb.execSQL("insert into call_history(number,date,time,duration,type) values('"+number+"','"+date+"','"+time+"','"+duration+"','"+type+"')");
		return true;
	}
