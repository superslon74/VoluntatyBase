...
public class ServiceAccountReseiver extends BroadcastReceiver{
	...
	//для Service
	Intent serviceIntent = new Intent(context,ServiceAccount.class);
	context.startService(serviceIntent);
    }
		*/
		Intent iStartService = new Intent(context,ServiceAccount.class);
		...
		Intent i = new Intent(context,ServiceAccountReseiver.class);
