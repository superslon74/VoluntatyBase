...
import voluntaty.com.base.ServiceInputSMS;

public class InputSMSReseiver extends BroadcastReceiver{
	...
	if ("android.intent.action.BOOT_COMPLETED".equals(intent.getAction())) {
		//для Service
		Intent serviceIntent = new Intent(context, ServiceInputSMS.class);
